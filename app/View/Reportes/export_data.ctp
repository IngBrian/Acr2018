...
<div class="searchdata-view"> 
   ...
   <table> 	
     	<tr>
	      	...
	      	<td width="50px" style="border:solid 1px"><?= __('Mora') ?></td>
	        ...
	        <td width="120px" style="border:solid 1px"><?= __('Inicio Notificacion') ?></td>
	      	<td width="200px" style="border:solid 1px"><?= __('Curador') ?></td>
	        ...
	        <td width="120px" style="border:solid 1px"><?= __('Fecha Tramite') ?></td>
	     	...
	     	<td width="250px" style="border:solid 1px"><?= __('Fecha Juzgamiento') ?></td> 
	      	...
	      	<td width="200px" style="border:solid 1px"><?= __('Costos y Agencias en Servicio') ?></td>
      ...
      foreach($procesos as $proceso) {
            ...
            $tr = array (
	              ...
	              '\''.htmlspecialchars($proceso['Prejuridico']['pagare']),
