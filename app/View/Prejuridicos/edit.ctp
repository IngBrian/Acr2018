   <div class="container">
        ...
        <?= $this->Form->input('tproceso_id', array('options' => $tprocesos, 'type' => 'select', 'empty' => '<< Seleccione Tipo de Negocio >>', 'label' => false,  'class' => 'form-control', 'value' => $prejuridico['Prejuridico']['tproceso_id'],'id'=>'tproceso')) ?>
        
        <?= $this->Form->input('ordenante_id', array('options'=> $ordenantes, 'type' => 'select', 'empty' => '<< Seleccione Vendedor >>', 'label' => false, 'class' => 'form-control', 'value' => $prejuridico['Prejuridico']['ordenante_id'], 'id' => 'id_demandante')) ?>
        
        <?= $this->Form->input('cliente_id', array('options'=> $clientes, 'type' => 'select', 'empty' => '<< Seleccione  Comprador >>', 'label' => false, 'class' => 'form-control', 'id' => 'id_deudor', 'value' => $prejuridico['Prejuridico']['cliente_id'])) ?>
        ...
        <?= $this->Form->input('juzgado_id', array('options' => $juzgados, 'type' => 'select', 'empty' => '<< Seleccione Forma de Pago >>', 'label' => false, 'id' => 'juzgado', 'class' => 'form-control', 'value' => $prejuridico['Prejuridico']['juzgado_id'])) ?>
        ...
        <?= $this->Form->input('pagare', array('label' => false, 'placeholder' => 'Estrato','class'=>'form-control' ,'value' => $prejuridico['Prejuridico']['pagare']))?>
           
        <?= $this->Form->input('saldo_int', array('label' => false, 'class' => 'form-control', 'placeholder' => 'Cuantia', 'value' => $prejuridico['Prejuridico']['saldo_int']))?>
