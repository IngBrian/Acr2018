...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-default panel-container-album">
            <div class="panel-heading">
                ...
                <?php echo $this->Html->link(
                    '<i class="fa fa-cloud-upload"></i> ' . __d('gallery', 'Subir Imagen'),
                    'javascript:void(0)',
                    array(
                        'escape' => false,
                ...
                <?php echo $this->Html->link(
                    '<i class="fa fa-external-link"></i> ' . __d('gallery', 'Ver Album'),
                    array(
                        'controller' => 'albums',
                        'action' => 'view',
                        $album['Album']['id'],
     ...
     <?php echo $this->Html->link('Retornar', '/gallery/index/'.$model_id, array('class' => 'btn btn-info btn-sm pull-right','style'=>'margin-right: 0px; margin-left: 10px')); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="manipulation">
                                            <?php echo $this->Form->input(
                                                ...
                                                array(
                                                    'type' => 'radio',
                                                    'value' => !empty($album) ?  'published':$album['Album']['status'] ,
                                                    'legend' => false,
                                                    'separator' => '',
                                                    'options' => array(
                ...
                <div id="container-pictures">
                    ...
                    <?php if (!count($album['Picture'])) { ?>
                        <div class="container-empty">
                            ...
                            <h2><?php echo __d('gallery', "Este Album no tiene imagenes aun."); ?></h2>
                            <br/>
                            <a href="javascript:void(0)" class="btn btn-success uploadButton">
                                <i class="fa fa-cloud-upload"></i>
                                <?php echo __d('gallery', 'Pulsa click en subir imagen o arrastra la imagen aqui. '); ?>
                            </a>
                        </div>
                    <?php } ?>
                </div>
