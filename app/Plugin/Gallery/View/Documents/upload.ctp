...
<div id="albumInfo" data-album-id="<?php echo $document['Document']['id'] ?>"
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-default panel-container-album">
            <div class="panel-heading">
                ...
                <?php echo $this->Html->link(
                    '<i class="fa fa-cloud-upload"></i> ' . __d('gallery', 'Subir Documento'),
                    'javascript:void(0)',
                    array(
                        'escape' => false,
                ...
                <?php echo $this->Html->link(
                    '<i class="fa fa-external-link"></i> ' . __d('gallery', 'Ver Documentos'),
                    array(
     ...
     <?php echo $this->Html->link('Retornar', '/galleryd/index/'.$model_id, array('class' => 'btn btn-info btn-sm pull-right','style'=>'margin-right: 0px; margin-left: 10px')); ?>
            ...
            <div class="panel-body uploader-panel">
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        $data = $this->Js->get('#DocumentUpdateForm')->serializeForm(
                            array('isForm' => true, 'inline' => true)
                        );
                        $this->Js->get('#DocumentUpdateForm')->event(
                            'submit',
                            $this->Js->request(
                                array('action' => 'update'),
                                array(
                                    ...
                                    'dataExpression' => true,
                                    'method' => 'POST',
                                    'complete' => 'toastr.success("Documento Guardado!"); $(".panel.options").slideToggle()'
                                )
                            )
                        );
                        echo $this->Form->create('Gallery.Document', array('action' => 'update', 'default' => false));
                        ?>
                        <div class="panel panel-success options">
                            ...
                            <div class="panel-body options">
                                <?php if (!empty($document)) { ?>
                                    <?php echo $this->Form->input('id', array('value' => $document['Document']['id'])) ?>
                                <?php } ?>
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php echo $this->Form->input(
                                            'title',
                                            array(
                                                'value' => !empty($document) ? $document['Document']['title'] : '',
                                    ...
                                    <div class="col-md-3">
                                        <?php echo $this->Form->input(
                                            'tags',
                                            array(
                                                'value' => !empty($document) ? $document['Document']['tags'] : '',
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="manipulation">
                                            <?php echo $this->Form->input(
                                                ...
                                                array(
                                                    'type' => 'radio',
                                                    'value' => !empty($document) ?  'published':$album['Document']['status'] ,
                                                    'legend' => false,
                                                    'separator' => '',
                                                    'options' => array(
                ...
                <div id="container-pictures">
                    ...
                    <?php if (!count($document['Archivo'])) { ?>
                        <div class="container-empty">
                            <div class="img"><i class="fa fa-picture-o"></i></div>
                            <h2><?php echo __d('gallery', "Este Album de documentos no tiene archivos aun."); ?></h2>
                            <br/>
...
<div id="folderinfo"
     data-public-folder-path="<?php echo $this->params->webroot . "files/documentos/" . $document['Document']['id'] . "/" ?>"></div>
...
<li class="col-xs-6 col-md-3 ui-state-default" alt="{{id}}"
    ...
    <div class="thumbnail th-pictures-container" style="position: relative">
        <a href="{{path}}" title="{{caption}}" class=""><img src="{{url}}" alt=""></a>
