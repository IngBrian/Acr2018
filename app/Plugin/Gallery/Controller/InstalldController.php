...
class InstalldController extends GalleryAppController
{
    ...
    public function configure()
    {
        ...
        $galleries_path = $files_path . 'documentos' . DS;
    ...
    {
        return !!in_array('gallery_documents', $tables) && !!in_array('gallery_archivos', $tables);
    }
