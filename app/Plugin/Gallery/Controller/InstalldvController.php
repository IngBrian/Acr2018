...
class InstalldvController extends GalleryAppController
{
    ...
    public function configure()
    {
        ...
        $galleries_path = $files_path . 'multimedia' . DS;
    ...
    {
        return !!in_array('gallery_bags', $tables) && !!in_array('gallery_items', $tables);
    }
