...
class LogPicture extends GalleryAppModel
{
    ...
    public $order = 'LogPicture.order ASC';
    ...
    */
    ...
    {
        return (int)$this->find('count', array('conditions' => array('LogPicture.album_id' => $album_id))) + 1;
    }
    /**
     * @param $results
     * @param bool $primary
