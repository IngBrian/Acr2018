var pathIcons="/files/documentos/icons/";
var Album = {
    init: function (settings) {
        Album.config = {
            ...
            editable: {
                postUrl: $('body').data('plugin-base-url') + '/archivos/caption'
            },
            dropzone: {
         ...
         * @type {string}
         */
        Album.config.fetchUrl = Album.config.baseUrl + '/archivos/index/' + Album.config.id;
         ...
         * @type {string}
         */
        Album.config.deleteUrl = Album.config.baseUrl + '/archivos/delete/';
         ...
         * @type {string}
         */
        Album.config.sortUrl = Album.config.baseUrl + '/archivos/sort';
    ...
    fetch: function () {
        $.getJSON(Album.config.fetchUrl, function (response) {
            ...
            for (var i = 0; i < archivos.length; i++) {
               var url=Album.getExt(archivos[i].link);
   ...
   getExt: function (ext){
        ...
        if( (ext.indexOf(".doc")>1) || (ext.indexOf(".docx")>1)) {
            return pathIcons+"word.png";

        }else if( (ext.indexOf(".xls")>1) || (ext.indexOf(".xlsx")>1)) {
            return pathIcons+"excel.png"

        }else if ((ext.indexOf(".pdf")>1) ){
            return pathIcons+"pdf.png"
