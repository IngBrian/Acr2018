...
class PrejuridicosController extends AppController {
    ...
    if (in_array($this->action, array('add','export_excel','excelpagos','searchadv'))) {
    ...
    if (in_array($this->action, array('add','export_excel','excelpagos','edit','bitacora','searchadv'))) {
    ...
    public function beforeFilter() {
        $this->Auth->allow('view','indexseg','subestado');
        parent::beforeFilter();
        $this->loadData();
    }
    ...
    private function loadData(){
    	...
    	$options = array('pagare' => 'No FACTURA','guia' => 'No MATRICULA','guia2' => 'FECHA ESCRITURA','ntitulo' => 'ESCRITURA','nit'=>'IDENTF. OTORGANTE I','nit_cc'=>'IDENTF. OTORGANTE II');
